...
//                product.quntity = Int64(newQuantity)
//                
//                // Recalculate the total price and quantity of the invoice
//                var total = 0.0
//                var totalQuantity = 0
//                
//                // Fetch all products in the invoice
//                let fetchRequestAllProducts: NSFetchRequest<CartProductEntity> = CartProductEntity.fetchRequest()
//                fetchRequestAllProducts.predicate = NSPredicate(format: "invoice == %@", invoice)
//                
//                do {
//                    let resultsAllProducts = try context.fetch(fetchRequestAllProducts)
//                    for product in resultsAllProducts {
//                        // Calculate the total value for each product
//                        let quantity = product.quntity
//                        let price = product.price
//                        let totalValue = Double(quantity) * price
//                        total += totalValue
//                        totalQuantity += Int(Int32(quantity))
//                    }
//                } catch {
//                    print("Failed to fetch products: \(error.localizedDescription)")
//                    return
//                }
//                
//                // Update the invoice total price and quantity
